...
campaign_template_columns = ['date', 'period', 'year', 'cid', 'name', 'pid', 'spending', 'reach', 'impression', 'engagement',
...
def FBTransform():
    ...
    fb_campaign['period'] = fb['period']
    fb_campaign['year'] = fb['year']
    ...
    ig_campaign['period'] = ig['period']
    ig_campaign['year'] = ig['year']
...
def LPTransform():
    ...
    lp_campaign['period'] = lp['period']
    lp_campaign['year'] = lp['year']
    ...
    lp_campaign_group['period'] = unique_group['period']
    lp_campaign_group['year'] = unique_group['year']
...
def LMTransform():
    ...
    lm_campaign['period'] = lm['period']
    lm_campaign['year'] = lm['year']
...
def GCTransform():
    ...
    ga_campaign['period'] = ga['period']
    ga_campaign['year'] = ga['year']
...
def GSTransform():
    ...
    site_traffic_template_columns = [
        'sid', 'pid', 'period', 'year', 'uri', 'all_user', 'new_user', 'order_count', 'revenue', 'dateadded']
    ...
    fb_st['period'] = dfga_fb['period']
    fb_st['year'] = dfga_fb['year']
    ...
    ig_st['period'] = dfga_ig['period']
    ig_st['year'] = dfga_ig['year']
    ...
    ln_st['period'] = dfga_line['period']
    ln_st['year'] = dfga_line['year']
    ...
    g_st['period'] = dfga_google['period']
    g_st['year'] = dfga_google['year']
    ...
    go_st['period'] = dfga_gorganic['period']
    go_st['year'] = dfga_gorganic['year']
    ...
    d_st['period'] = dfga_direct['period']
    d_st['year'] = dfga_direct['year']
    ...
    o_st['period'] = dfga_other['period']
    o_st['year'] = dfga_other['year']
